...
"""Attention layer with HybridSparseAttention."""
...
class HybridSparseAttentionBackend(AttentionBackend):
    ...
    def supports_attn_type(cls, attn_type: str) -> bool:
        """HybridSparseAttention supports all attention types."""
        return attn_type in (
    ...
    @staticmethod
    def get_impl_cls() -> type["HybridSparseAttentionImpl"]:
        return HybridSparseAttentionImpl

    @staticmethod
    def get_builder_cls() -> type["HybridSparseAttentionMetadataBuilder"]:
        return HybridSparseAttentionMetadataBuilder
...
@dataclass
class HybridSparseAttentionMetadata:
...
def _get_sliding_window_configs(
    ...
    for layer in layers.values():
        assert isinstance(layer.impl, HybridSparseAttentionImpl)
        sliding_window_configs.add(layer.impl.sliding_window)
    return sliding_window_configs


class HybridSparseAttentionMetadataBuilder(AttentionMetadataBuilder[HybridSparseAttentionMetadata]):
    # FA3:
    ...
    def build(
        ...
        def schedule(
            ...
            if cache_dtype.startswith("fp8"):
                qkv_dtype = HybridSparseAttentionBackend.get_fp8_dtype_for_flashattn(
                    cache_dtype
                )
            else:
        ...
        attn_metadata = HybridSparseAttentionMetadata(
    ...
    def update_block_table(
        self,
        metadata: HybridSparseAttentionMetadata,
...
class HybridSparseAttentionImpl(AttentionImpl):
    ...
    def __init__(
        ...
        if is_quantized_kv_cache(self.kv_cache_dtype) and not flash_attn_supports_fp8():
            raise NotImplementedError(
                "HybridSparseAttention does not support fp8 kv-cache on this device."
            )

        self.sinks = sinks
        if self.sinks is not None:
            assert flash_attn_supports_sinks(), (
                "Sinks are only supported in HybridSparseAttention 3"
            )
    ...
    def forward(
        ...
        """Forward pass with HybridSparseAttention.
        ...
        assert self.vllm_flash_attn_version is not None, (
            "HybridSparseAttention version not detected."
        )

        if output_scale is not None or output_block_scale is not None:
            raise NotImplementedError(
                "fused output quantization is not yet supported for HybridSparseAttentionImpl"
            )
        ...
        if self.kv_cache_dtype.startswith("fp8"):
            ...
            dtype = HybridSparseAttentionBackend.get_fp8_dtype_for_flashattn(
                self.kv_cache_dtype
            )
